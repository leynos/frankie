//! Library-facing types and services for time-travel workflows.
//!
...
//! metadata, the runtime state container used by renderers and hosts, and the
//! shared orchestration services that load and navigate historical snapshots.
//!
//! # Example
//!
//! ```
...
pub use service::{
    TimeTravelNavigationDirection, load_time_travel_state, navigate_time_travel_state,
};
